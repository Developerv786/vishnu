...
function Slide() {
          return (
            ...
            <div class="carousel-inner">
              ...
              <Link to="/Help"> <img src={Lion} class="d-block w-100" alt="..."/> </Link>
              </div>
              <div class="carousel-item">
              <Link to="/Help"> <img src={House} class="d-block w-100" alt="..."/> </Link> 
              </div>
              <div class="carousel-item">
              <Link to="/Help"> <img src={Spiderman} class="d-block w-100" alt="..."/> </Link> 
              </div>
              <div class="carousel-item">
              <Link to="/Help"> <img src={Bike} class="d-block w-100" alt="..."/> </Link>
              </div>
              <div class="carousel-item">
              <Link to="/Help"> <img src={Tajmahal} class="d-block w-100" alt="..."/> </Link>
              </div>
              <div class="carousel-item">
              <Link to="/Help"> <img src={Car} class="d-block w-100" alt="..."/> </Link>
              </div>
              <div class="carousel-item">
              <Link to="/Help"> <img src={Laptop} class="d-block w-100" alt="..."/> </Link>
              </div>
              <div class="carousel-item">
              <Link to="/Help"> <img src={Unicorn} class="d-block w-100" alt="..."/> </Link>
              </div>
              <div class="carousel-item">
              <Link to="/Help"> <img src={Aeroplane} class="d-block w-100" alt="..."/> </Link>
              </div>
              <div class="carousel-item">
              <Link to="/Help"> <img src={Ship} class="d-block w-100" alt="..."/> </Link>
              </div>
            </div>
